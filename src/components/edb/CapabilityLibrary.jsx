...
export const CAPABILITY_LIBRARY = [
  ...
  { type: 'Civilian Bonus', subtype: 'Construction bonus (cost, stone)',     code: 'construction_cost_bonus_stone',     args: 'bonus', range: '1-100', description: 'RTW legacy capability; keep only when your EDB already uses it.' },
  { type: 'Civilian Bonus', subtype: 'Construction bonus (cost, wooden)',    code: 'construction_cost_bonus_wooden',    args: 'bonus', range: '1-100', description: 'RTW legacy capability; keep only when your EDB already uses it.' },
