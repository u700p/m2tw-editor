...
export function serializeEDB(edbData) {
  let output = ';This file is generated by the Rome: Total War Mod Editor\n\n\n\n\n';
...
export function serializeTextFile(textData) {
  return serializeTextLocFile(textData, { header: 'Generated by Mylae Rome: Total War Mod Editor' });
}
